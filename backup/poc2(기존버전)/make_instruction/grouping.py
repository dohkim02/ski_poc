...
class ExcelGroupProcessor:
    ...
    def group_and_calculate_with_grade(self, group_columns=["등급", "그룹", "용도"]):
        """
        등급을 포함한 지정된 컬럼들을 기준으로 그룹화하고 적응형 통계 계산
