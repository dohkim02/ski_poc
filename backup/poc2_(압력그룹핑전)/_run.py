...
class Analyze:
    ...
    async def pattern_checker(self, rest_month_data, latest_6_month_data):
        ...
        result = await asyncio.to_thread(
            chain.invoke,
            {
                "rest_month_data": rest_month_data,
                "latest_6_month_data": latest_6_month_data,
            },
        )
    ...
    async def run_pattern_check(self, outlier_results):
        ...
        async def process_pattern_check(outlier_item):
            async with semaphore:
                ...
                pattern_result = await self.pattern_checker(
