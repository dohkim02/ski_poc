    ...
    try:
        ...
        try:
            ...
            if pd.notna(meter_current) and pd.notna(uncorrected_current):
                if meter_current - uncorrected_current >= 30:
        ...
        try:
            ...
            if (
                ...
                if abs(last_year_factor - current_factor) / current_factor >= 0.04:
        ...
        try:
            ...
            if (
                ...
                if abs(last_month_factor - current_factor) / current_factor >= 0.04:
        ...
        try:
            ...
            if (
                ...
                and last_month_usage >= 100
                and last_year_usage >= 100
                and current_usage == 0
            ):
                flags.append("미사용세대")
        except:
        ...
        try:
            ...
            if (
                ...
                if ratio <= 0.5:  # 50% 이하로 감소 (즉, 50% 이상 감소)
                    flags.append("전월 대비 급감")
        except:
            pass

        # 6. 전년동월 대비 급감 체크 (50% 이상 감소)
        try:
            last_month_usage = row.get("계량기-전월사용량", 0)
            last_year_usage = row.get("계량기-전년동월사용량", 0)
            current_usage = row.get("계량기-당월사용량", 0)
...
def process_excel_parallel(input_file, output_file=None, max_workers=None):
    """
...
def main():
    ...
    process_excel_parallel(input_file, output_file, max_workers=4)
